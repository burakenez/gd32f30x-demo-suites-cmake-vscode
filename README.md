[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32f30x-demo-suites-cmake-vscode)](https://github.com/burakenez/gd32f30x-demo-suites-cmake-vscode/tags/)

# GD32F30x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32F30x Demo Suites CMake Visual Studio Code** repository! This project is designed to integrate the CMake build system with Visual Studio Code, providing a streamlined development environment for **_GD32F30x Demo Suites V3.0.1_**.
...
- **🧩 Lightweight Templates:** A structured and organized template for GD32F30x microcontroller projects.
...
### 2. **CMSIS/GD/GD32F30x**
- **Version:** `V3.0.1 (2024-12-20)`
- **Path:** `Drivers/CMSIS/GD/GD32F30x`
- Extracted from `GD32F30x Demo Suites V3.0.1`

### 3. **GD32F30x_standard_peripheral**
- **Version:** `V3.0.1 (2024-12-20)`
- **Path:** `Drivers/GD32F30x_standard_peripheral`

### 4. **GD32F30x_usbd_library**
- **Version:** `V3.0.1 (2024-12-20)`
- **Path:** `Drivers/GD32F30x_usbd_library`

### 5. **GD32F30x_usbfs_library**
- **Version:** `V3.0.1 (2024-12-20)`
- **Path:** `Drivers/GD32F30x_usbfs_library`
...
git clone --recursive https://github.com/burakenez/gd32f30x-demo-suites-cmake-vscode.git
```
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32f30x_it.h  # Interrupt handler declarations specific to GD32F30x.
│           │   │   │   ├── gd32f30x_libopt.h  # Library options and configurations for efficient use.
│           │   │   │   └── systick.h  # Definitions and declarations related to the SysTick timer.
│           │   │   ├── Src
│           │   │   │   ├── gd32f30x_it.c  # Interrupt service routine implementations.
│           │   │   │   ├── main.c  # Entry point of the application, containing the main logic and system initialization.
│           │   │   │   ├── system_gd32f30x.c  # System initialization, clock setup, and core configurations.
│           │   │   │   └── systick.c  # SysTick timer setup and related functionalities.
│           │   ├── Startup
│           │   │   └── startup_gd32f30x.s  # Assembly code for initialization and vector table setup.
│           │   ├── User
...
│           ├── Drivers
│           │   ├── BSP/GD32F303B_EVAL  # Board support package configurations and drivers for GD32F303B_EVAL.
│           │   ├── CMSIS  # CMSIS drivers for Cortex-M processors, supporting GD32F30x.
│           │   └── GD32F30x_standard_peripheral  # Peripheral library for GD32F30x.
...
│           ├── gd32f30x_flash.ld  # Linker script for defining memory regions and placements.
│           └── GD32F30x.svd  # System View Description file for debugging and register definitions. 
